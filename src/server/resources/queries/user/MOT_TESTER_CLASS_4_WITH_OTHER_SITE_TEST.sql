...
and o.slots_balance > 50 -- ae's with slots available
...
and mtc.completed_date > DATE_SUB(CURDATE(), INTERVAL 10 DAY)  -- recent tests only, fixes data issues with new certs
