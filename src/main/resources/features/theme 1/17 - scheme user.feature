...
Feature: 17 - Scheme user
  ...
  Scenario: Verify that the scheme user is able to create a new special notice from the new inbox, preview the special notice and then save as a draft and then publish and finally delete the special notice from the new inbox.
    ...
    #Select the Special notice radio button and continue, populate all details within the page
