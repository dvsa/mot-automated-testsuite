...
/**
 * Reporting class used to generate HTML reports based on the Cucumber json report generated by the test runner.
 */
public class CucumberReporting {
     ...
     * @throws Exception
     */
    private static void generateFeatureReport(String outputDirectory, String sourceFile, String outputName, String screenShotLocation) throws Exception {
     ...
     * @throws Exception
     */
    private static void generateOverviewReport(String outputDirectory, String sourceFile, String outputName) throws Exception {
