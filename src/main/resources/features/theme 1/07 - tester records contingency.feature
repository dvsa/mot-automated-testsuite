...
#    And I enter "{hour2}" in the field with id "contingency_time-hour"
#    And I enter "{min2}" in the field with id "contingency_time-minutes"
#    And I select "{ampm2}" in the field with id "contingency_time-ampm"
