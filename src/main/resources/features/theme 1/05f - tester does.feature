...
#      | 123,456 miles                                                |
#
#  Scenario: Tester enters a class 4 MOT test fail, with a major brake imbalance test failure
...
#      | 12,345 miles                       |
  ...
  Scenario: Tester enters a class 7 MOT test fail, with a dangerous brake imbalance test failure
