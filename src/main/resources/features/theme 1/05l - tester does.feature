...
Feature: 05l - Tester does...
  ...
  Scenario: Tester enters a class 7 MOT test fail with a major brake imbalance failure on a single line 3 axle vehicle using a roller test
    ...
    And I enter single line 3 axle class 7 roller results for vehicle weight of 1000 as service brake 200,200,200,200,200,130 and parking brake 200,200
    ...
    And I check the major failures section of the brake test summary of the test summary has "Axle 3"
  ...
  Scenario: Tester enters a class 4 MOT test fail with a dangerous brake imbalance failure on a single line 3 axle vehicle using a roller test
    ...
    And I enter single line 3 axle class 4 roller results for vehicle weight of 1000 as service brake 200,20,200,200,200,200 and parking brake 200,200
  ...
  Scenario: Tester enters a class 7 MOT test fail with a major brake failure on a single line 3 axle vehicle using a roller test
    Given I load "VEHICLE_CLASS_7" as {registration1}, {vin1}, {mileage1}
    And I login with 2FA using "MOT_TESTER_CLASS_7" as {username1}, {site}
    ...
    And I enter single line 3 axle class 7 roller results for vehicle weight of 1000 as service brake 50,50,50,50,50,50 and parking brake 200,200
  ...
  Scenario: Tester enters a class 5 MOT test fail with a dangerous brake failure on a single line 3 axle vehicle using a roller test
    ...
    And I enter single line 3 axle class 7 roller results for vehicle weight of 1000 as service brake 22,22,22,22,22,22 and parking brake 200,200
  ...
  Scenario: Tester enters a class 4 MOT test fail with a major parking brake failure on a single line 3 axle vehicle using a roller test
    Given I load "VEHICLE_CLASS_4_BEFORE_2010" as {registration1}, {vin1}, {mileage1}
    And I login with 2FA using "MOT_TESTER_CLASS_4" as {username1}, {site}
    ...
    And I enter single line 3 axle class 4 roller results for vehicle weight of 1000 as service brake 200,200,200,200,200,200 and parking brake 66,66
  ...
  Scenario: Tester enters a class 4 MOT test fail with a dangerous parking brake failure on a single line 3 axle vehicle using a roller test
    Given I load "VEHICLE_CLASS_4_BEFORE_2010" as {registration1}, {vin1}, {mileage1}
    And I login with 2FA using "MOT_TESTER_CLASS_4" as {username1}, {site}
    ...
    And I enter single line 3 axle class 4 roller results for vehicle weight of 1000 as service brake 200,200,200,200,200,200 and parking brake 23,23
