...
Feature: 05h - Tester does...
  ...
  Scenario: Tester enters a class 4 MOT test fail with a major brake imbalance failure on a single line 3 axle vehicle using a plate test
    ...
    And I enter single line 3 axle class 4 plate results for weights of 1000 as service brake 200,200,200,200,200,130 and parking brake 200,200
  ...
  Scenario: Tester enters a class 4 MOT test fail with a dangerous brake imbalance failure on a single line 3 axle vehicle using a plate test
    Given I load "VEHICLE_CLASS_4_BEFORE_2010" as {registration1}, {vin1}, {mileage1}
    And I login with 2FA using "MOT_TESTER_CLASS_4" as {username1}, {site}
    ...
    And I enter single line 3 axle class 4 plate results for weights of 1000 as service brake 200,10,200,200,200,200 and parking brake 200,200
  ...
  Scenario: Tester enters a class 4 MOT test fail with a major brake failure on a single line 3 axle vehicle using a plate test
    ...
    And I enter single line 3 axle class 7 plate results for weights of 1000 as service brake 50,50,50,50,50,50 and parking brake 200,200
  ...
  Scenario: Tester enters a class 4 MOT test fail with a dangerous brake failure on a single line 3 axle vehicle using a plate test
    ...
    And I enter single line 3 axle class 4 plate results for weights of 1000 as service brake 20,20,20,20,20,20 and parking brake 200,200
  ...
  Scenario: Tester enters a class 4 MOT test fail with a major parking brake failure on a single line 3 axle vehicle using a plate test
    Given I load "VEHICLE_CLASS_7" as {registration1}, {vin1}, {mileage1}
    And I login with 2FA using "MOT_TESTER_CLASS_7" as {username1}, {site}
    ...
    And I enter single line 3 axle class 7 plate results for weights of 1000 as service brake 100,100,100,100,100,100 and parking brake 60,60
  ...
  Scenario: Tester enters a class 4 MOT test fail with a dangerous parking imbalance failure on a single line 3 axle vehicle using a plate test
    ...
    And I enter single line 3 axle class 4 plate results for weights of 1000 as service brake 100,100,100,100,100,100 and parking brake 24,24
