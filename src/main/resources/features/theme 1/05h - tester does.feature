@extended
Feature: 05h - Tester does...

  Scenario: Tester enters a class 4 MOT test fail, with a single line major brake imbalance failure on a plate
    ...
    And I enter single line class 4 plate results for weights of 1000 as service brake 200,200,200,130 and parking brake 100,100
    ...
    And I check the major failures section of the brake test summary of the test summary has "Axle 2"
  ...
  Scenario: Tester enters a class 4 MOT test fail, with a single line dangerous brake imbalance failure on a plate
    Given I load "VEHICLE_CLASS_4_BEFORE_2010" as {registration1}, {vin1}, {mileage1}
    And I login with 2FA using "MOT_TESTER_CLASS_4" as {username1}, {site}
    ...
    And I enter single line class 4 plate results for weights of 1000 as service brake 200,20,200,200 and parking brake 200,200
    ...
    And I check the vehicle summary section of the test summary has "Result" of "FAIL"
    And I check the brake test summary section has "Brake results overall" of "Fail"
    And I check the dangerous failures section of the brake test summary of the test summary has "Brakes imbalanced more than 50% across an axle"
  ...
  Scenario: Tester enters a class 7 MOT test fail, with a single line major brake failure on a plate
    ...
    And I enter single line class 7 plate results for weights of 1000 as service brake 100,100,100,100 and parking brake 100,100
  ...
  Scenario: Tester enters a class 4 MOT test fail, with a single line dangerous brake failure on a plate
    Given I load "VEHICLE_CLASS_4_BEFORE_2010" as {registration1}, {vin1}, {mileage1}
    And I login with 2FA using "MOT_TESTER_CLASS_4" as {username1}, {site}
    ...
    And I enter single line class 4 plate results for weights of 1000 as service brake 50,50,50,50 and parking brake 200,200
  ...
  Scenario: Tester enters a class 4 MOT test fail, with a single line major parking brake failure on a plate
    Given I load "VEHICLE_CLASS_4_BEFORE_2010" as {registration1}, {vin1}, {mileage1}
    And I login with 2FA using "MOT_TESTER_CLASS_4" as {username1}, {site}
    ...
    And I enter single line class 4 plate results for weights of 1000 as service brake 200,200,200,200 and parking brake 60,60
  ...
  Scenario: Tester enters a class 7 MOT test fail, with a single line dangerous parking brake failure on a plate
    Given I load "VEHICLE_CLASS_7" as {registration1}, {vin1}, {mileage1}
    And I login with 2FA using "MOT_TESTER_CLASS_7" as {username1}, {site}
    ...
    And I enter single line class 7 plate results for weights of 1000 as service brake 200,200,200,200 and parking brake 24,25
